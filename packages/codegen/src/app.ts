...
export interface ViewSpecInput {
  description?: string;
  titleField?: string;
  layout?: "table" | "cards" | "board";
  metrics?: { label: string; agg: "count" | "sum" | "avg"; field?: string; format?: string }[];
  groupBy?: string;
  card?: { title?: string; subtitle?: string; badge?: string; meta?: string[] };
  columns: { field: string; format: string }[];
  formFields: string[];
}
...
export function generateApp(
  ...
  viewSpecs?: Record<string, ViewSpecInput>, // optional LLM-designed per-entity screen specs (data, not code)
