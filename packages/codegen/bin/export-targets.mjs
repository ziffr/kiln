...
## The spine
The command API the UI/n8n/Odoo call is **not yet a deployable service** — its handlers are stubs
(TODO.md). Implement them (as a small Node/serverless service, or map commands onto Odoo/Postgres
functions), deploy it, and set its URL everywhere above.
