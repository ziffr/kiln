...
function messagesTs(base: Record<string, string>, sourceLang: string, translations: Record<string, Record<string, string>>): string {
  ...
  return [
    `// Generated by @vbd/codegen ui — i18n message bundle. The base locale (${JSON.stringify(sourceLang)}) is`,
...
function i18nRuntimeTsx(): string {
  return [
    `// Generated by @vbd/codegen ui — a tiny i18n runtime (no dependency). t(key, fallback) resolves the`,
...
function themeToggleTsx(): string {
  return [
    `// Generated by @vbd/codegen ui — light/dark toggle (toggles the .dark class + persists the choice).`,
    `import { useState } from "react";`,
    "",
...
function appHeaderTsx(): string {
  return [
    `// Generated by @vbd/codegen ui — top bar: toggle + breadcrumb + search + language + theme (sidebar-16).`,
...
export function shadcnAdapter(caps: CapabilityDoc, domain: DomainDoc, contexts?: ContextsDoc, theme: Theme = DEFAULT_THEME, workflows?: WorkflowsDoc, roles?: RolesDoc, i18n?: { sourceLang?: string; translations?: Record<string, Record<string, string>> }): Record<string, string> {
